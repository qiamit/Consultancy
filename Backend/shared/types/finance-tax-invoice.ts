export type FinanceTaxInvoiceLineRow = {
  id: string;
...
export type FinanceTaxInvoiceRow = {
  id: string;
  tax_invoice_number: string;
  tax_status: "pending" | "accepted" | "cancelled";
  tax_date: string;
  ...
  finance_tax_invoice_lines?: FinanceTaxInvoiceLineRow[];
};
