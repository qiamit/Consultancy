  ...
  const { error } = await supabase.from("company_settings").upsert(
    {
      ...
      print_margin_top: Number(str(formData, "print_margin_top")) || 10,
      print_margin_bottom: Number(str(formData, "print_margin_bottom")) || 10,
      print_margin_left: Number(str(formData, "print_margin_left")) || 10,
      print_margin_right: Number(str(formData, "print_margin_right")) || 10,
