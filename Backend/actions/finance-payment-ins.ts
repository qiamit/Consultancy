...
const LIST_PATH = "/dashboard/finance/sales/payment-in";
...
export async function saveFinancePaymentIn(formData: FormData) {
...
export async function deleteFinancePaymentIn(id: string) {
  const supabase = await createClient();
