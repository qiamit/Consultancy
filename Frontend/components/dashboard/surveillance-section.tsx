...
} from "@backend/actions/license-surveillance";
...
function SurveillanceAddModal({ onClose, onAdded }: { onClose: () => void; onAdded: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
      <div className="w-full max-w-[19.6rem] rounded-2xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <div className="rounded-2xl border border-zinc-200/80 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      ...
      {rows.length === 0 ? (
        ...
        <div className="overflow-x-auto">
          <table className="dashboard-section-table w-full min-w-[560px] text-sm">
