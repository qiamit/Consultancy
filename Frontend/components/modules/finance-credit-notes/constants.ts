import { splitProformaInvoiceNumberForForm as splitProformaInvoiceNumberForFormLib } from "@backend/modules/finance/finance-credit-note-number";
import type { FinanceCreditNoteRow } from "@backend/shared/types/finance-credit-note";

export const CREDIT_NOTE_LIST_PATH =
  "/dashboard/finance/sales/credit-note";

export { splitProformaInvoiceNumberForFormLib as splitTaxInvoiceNumberForForm };
export { joinProformaInvoiceNumberParts as joinTaxInvoiceNumberParts } from "@backend/modules/finance/finance-credit-note-number";
...
export function rowToForm(
  row: FinanceCreditNoteRow,
  defaultBankDetails?: string,
): TaxInvoiceFormState {
  const linesRaw = row.finance_credit_note_lines ?? [];
  ...
  return {
    ...
    credit_note_number_prefix: qParts.credit_note_number_prefix,
    credit_note_number_value: qParts.credit_note_number_value,
