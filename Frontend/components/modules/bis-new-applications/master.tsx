...
import type { BisNewApplicationsFormDropdownOptions } from "@backend/shared/data/bis-new-applications-dropdowns";
...
} from "@backend/modules/bis/bis-new-application-csv";
      ...
      {embedIsCodeOpen ? (
        ...
        >
          <div
            ...
            className="mb-10 w-full max-w-5xl rounded-xl border-[2mm] border-zinc-300 bg-zinc-50 shadow-2xl dark:border-zinc-600 dark:bg-zinc-900 dark:shadow-black/40"
            onClick={(e) => e.stopPropagation()}
          >
            <IsCodeMasterForm
              visible
