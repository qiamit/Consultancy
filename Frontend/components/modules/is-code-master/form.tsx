  ...
  return (
    <div className={rootClass}>
      ...
      >
        ...
        <div className="sm:col-span-2 lg:col-span-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            ...
            <div className="min-w-0">
              ...
              <div className="flex overflow-hidden rounded-none border border-zinc-300 bg-white shadow-sm focus-within:border-sky-500 focus-within:ring-0 dark:border-zinc-700 dark:bg-zinc-950">
        ...
        <div className="sm:col-span-2 lg:col-span-4">
          <div className="overflow-hidden rounded-none border border-zinc-200 bg-zinc-50/70 shadow-sm dark:border-zinc-700 dark:bg-zinc-900/35">
            ...
            <div className="space-y-4 p-4">
              <div className="rounded-none border border-dashed border-zinc-300 bg-white px-4 py-5 dark:border-zinc-600 dark:bg-zinc-950/60">
                <input
              ...
              {existingFiles.length > 0 ? (
                <div className="space-y-2">
                  ...
                  <ul className="divide-y divide-zinc-200 overflow-hidden rounded-none border border-zinc-200 bg-white text-sm dark:divide-zinc-700 dark:border-zinc-700 dark:bg-zinc-950">
                    {existingFiles.map((f) => (
                      <li
                        key={f.id}
                      ...
                      >
                        ...
                        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
                          <button
                            type="button"
                            className="rounded-none px-2 py-1 text-xs font-medium text-sky-600 hover:bg-sky-50 hover:underline disabled:opacity-50 dark:text-sky-400 dark:hover:bg-sky-950/40"
                          ...
                          <button
                            type="button"
                            className="rounded-none px-2 py-1 text-xs font-medium text-red-600 hover:bg-red-50 hover:underline dark:text-red-400 dark:hover:bg-red-950/30"
        ...
        <div className="flex flex-wrap items-center justify-end gap-3 sm:col-span-2 lg:col-span-4">
          <button
            type="submit"
            className="rounded-none bg-sky-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-500"
          >
          ...
          {idParam && !isNewParam ? (
            <button
              type="button"
              onClick={onAddNew}
              className="rounded-none border border-zinc-300 bg-white px-4 py-2 text-sm font-medium text-zinc-800 shadow-sm hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
            >
              Clear / New
            </button>
          ) : null}
...
const fieldInputRowShellClass =
  "flex overflow-hidden rounded-none border border-zinc-300 bg-white shadow-sm focus-within:border-sky-500 focus-within:ring-0 dark:border-zinc-700 dark:bg-zinc-950";
    ...
    <div className="space-y-1">
      ...
      {suffix ? (
        ...
        <input
          ...
          className="block w-full rounded-none border border-zinc-300 bg-white px-3 py-2 text-sm shadow-sm outline-none focus:border-sky-500 focus:ring-0 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100"
        />
      )}
    </div>
  );
