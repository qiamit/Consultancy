...
function FileRow({
  ...
  return (
    <div className="flex items-center gap-3 rounded-none border border-zinc-200 bg-white px-3 py-2.5 dark:border-zinc-700 dark:bg-zinc-900">
  ...
  return (
    ...
    >
      <div
        ...
        className="flex max-h-[85vh] w-full max-w-xl flex-col rounded-none border border-zinc-200 bg-zinc-50 shadow-2xl dark:border-zinc-700 dark:bg-zinc-900"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 px-5 py-4 dark:border-zinc-700">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-none p-1.5 text-zinc-500 hover:bg-zinc-200 hover:text-zinc-700 dark:hover:bg-zinc-700 dark:hover:text-zinc-200"
            aria-label="Close"
          >
        ...
        <div className="border-t border-zinc-200 bg-white px-5 py-4 dark:border-zinc-700 dark:bg-zinc-900/50">
          ...
          <div className="flex items-center gap-3">
            <label className="flex flex-1 cursor-pointer items-center gap-2 rounded-none border border-dashed border-zinc-300 bg-zinc-50 px-3 py-2.5 text-sm text-zinc-600 hover:border-sky-400 hover:bg-sky-50/40 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-400 dark:hover:border-sky-500">
            ...
            <button
              ...
              className="shrink-0 rounded-none bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-sky-700 disabled:opacity-50 dark:bg-sky-700 dark:hover:bg-sky-600"
            >
