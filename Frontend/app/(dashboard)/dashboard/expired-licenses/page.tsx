...
export default async function ExpiredLicensesPage() {
  ...
  const { minus90Days } = dashboardLicenseDateBounds();
  ...
  // Expired = validity older than today − 90 days (past Deferred window)
  ...
  return (
    <div className="w-full">
      <PendingRenewalsSection
        rows={rows}
        sectionLabel="Expired Licenses"
        emptyMsg="No expired licenses found."
