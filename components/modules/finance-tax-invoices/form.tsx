...
import { DROPDOWN_KEY_FINANCE_TAX_INVOICE_CLIENT } from "@/lib/dropdown-keys";
...
export function FinanceTaxInvoiceForm({
  ...
  <div class="pad grid">
    ...
    <div class="right"><div class="title">PROFORMA INVOICE</div><div class="muted">Date: ${esc(formValues.tax_date || "-")} | Valid until: ${esc(formValues.valid_until_date || "-")}</div></div>
  </div>
  <div class="section">
  ...
  return (
    <div className={rootClass}>
        <div className="mb-4 flex items-start justify-between gap-3 border-b border-zinc-200 pb-3 dark:border-zinc-800">
          <div>
            <h2
              id="finance-tax-invoice-form-title"
