...
import { saveEmailAccount, deleteEmailAccount } from "@/lib/actions/email-accounts";
import type { EmailAccountSafe, EmailProvider } from "@/lib/types/email";
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-5">
          ...
          <label className="flex items-start gap-2 text-xs text-zinc-600 dark:text-zinc-400">
            <input
              ...
              className="mt-0.5"
            />
            Test IMAP/SMTP connection when saving (optional — account saves even if test fails)
          </label>
