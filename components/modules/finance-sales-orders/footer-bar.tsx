...
export function FinanceSalesOrdersFooterBar({
  matchedCount,
  grandCount,
  searchActive,
  grandTotalSum,
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                onClick={() => window.dispatchEvent(new CustomEvent("qe-assistant:open", { detail: { module: "finance-sales-order" } }))}
              >
                ✦ QE Assistant
              </button>
              <input
              ...
              <button
                ...
                title={
                  deleteDisabled
                    ? "Select one or more rows, or open a sales order with Edit, then use Delete"
                    : selectedCount > 0
                      ? `Delete ${selectedCount} selected sales order${selectedCount === 1 ? "" : "s"}`
                      : "Delete the sales order currently open for edit"
                }
                onClick={onDelete}
              >
                Delete
