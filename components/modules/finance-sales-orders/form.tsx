...
import { DROPDOWN_KEY_FINANCE_SALES_ORDER_CLIENT } from "@/lib/dropdown-keys";
...
export function FinanceSalesOrderForm({
  ...
  <div class="pad grid">
    ...
    <div class="right"><div class="title">SALES ORDER</div><div class="muted">Date: ${esc(formValues.order_date || "-")} | Expected delivery: ${esc(formValues.expected_delivery_date || "-")}</div></div>
  </div>
  <div class="section">
...
<div class="doc">${docInner}</div></body></html>`;
  ...
  const printSalesOrder = () => {
    const html = buildSalesOrderDocumentHtml();
  ...
  return (
    <div className={rootClass}>
        <div className="mb-4 flex items-start justify-between gap-3 border-b border-zinc-200 pb-3 dark:border-zinc-800">
          <div>
            <h2
              id="finance-sales-order-form-title"
            ...
            <div className="grid min-w-0 gap-3 lg:grid-cols-[minmax(0,450px)_minmax(0,1fr)]">
              <div className="min-w-0 max-w-full space-y-2">
                <ClientDropdownField
                  ...
                  onSuffixButtonClick={() => {
                    const rt = encodeURIComponent(salesOrderReturnUrl);
                    router.push(
