...
export function ClientMasterFooterBar({
  matchedCount,
  grandCount,
  searchActive,
  openingBalanceSum,
  ...
  return (
    <tfoot className="border-t border-zinc-200 bg-zinc-100 text-sm font-medium text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-200">
      <tr>
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                onClick={() => window.dispatchEvent(new CustomEvent("qe-assistant:open", { detail: { module: "clients" } }))}
              >
                QE Assistant
              </button>
              <button
              ...
              <button
                ...
                title={
                  deleteDisabled
                    ? "Select one or more rows, or open a client with Edit, then use Delete"
                    : selectedCount > 0
                      ? `Delete ${selectedCount} selected client${selectedCount === 1 ? "" : "s"}`
                      : "Delete the client currently open for edit"
                }
                onClick={onDelete}
              >
                Delete
        ...
        <td className="px-3 py-2 text-right align-middle tabular-nums">
          {openingBalanceSum.toLocaleString("en-IN", {
            style: "currency",
            currency: "INR",
