...
export function FinanceCustomerStatementsFooterBar({
  matchedCount,
  grandCount,
  searchActive,
  grandTotalSum,
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                title={
                  deleteDisabled
                    ? "Select one or more rows, or open a customer statement with Edit, then use Delete"
                    : selectedCount > 0
                      ? `Delete ${selectedCount} selected customer statement${selectedCount === 1 ? "" : "s"}`
                      : "Delete the customer statement currently open for edit"
                }
                onClick={onDelete}
              >
                Delete
