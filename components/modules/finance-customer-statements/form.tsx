...
import { DROPDOWN_KEY_FINANCE_CUSTOMER_STATEMENT_CLIENT } from "@/lib/dropdown-keys";
...
} from "@/lib/actions/finance-customer-statements";
import {
  ...
  return (
    <div className={rootClass}>
        <div className="mb-4 flex items-start justify-between gap-3 border-b border-zinc-200 pb-3 dark:border-zinc-800">
          <div>
            <h2
              id="finance-customer-statement-form-title"
