...
export function FinanceCustomerStatementForm({
  ...
  <div class="pad grid">
    ...
    <div class="right"><div class="title">PROFORMA INVOICE</div><div class="muted">Date: ${esc(formValues.statement_date || "-")} | Valid until: ${esc(formValues.valid_until_date || "-")}</div></div>
  </div>
  <div class="section">
            ...
            <div className="grid min-w-0 gap-3 lg:grid-cols-[minmax(0,450px)_minmax(0,1fr)]">
              <div className="min-w-0 max-w-full space-y-2">
                <ClientDropdownField
                  ...
                  onSuffixButtonClick={() => {
                    const rt = encodeURIComponent(customerStatementReturnUrl);
                    router.push(
