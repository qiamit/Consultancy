      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-3 sm:flex-row sm:items-center sm:gap-3">
          <div className="min-w-0 flex-1">
            <label htmlFor="finance-customer-statements-search" className="sr-only">
              Search statement number, dates, client, linked documents, type,
              totals, notes, and more
            </label>
            <input
              id="finance-customer-statements-search"
              type="search"
              value={searchQuery}
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2 sm:gap-3 sm:justify-end">
            <select
              id="finance-customer-statements-page-size"
              value={pageSize}
            ...
            {showPagination ? (
              <div className="flex w-full flex-wrap items-center gap-2 border-t border-zinc-200 pt-2 sm:w-auto sm:border-l sm:border-t-0 sm:pl-3 sm:pt-0 dark:border-zinc-600">
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                  <label
                    htmlFor="finance-customer-statements-go-page"
                    className={CLIENT_FIELD_LABEL_CLASS}
                  >
                    Go to
                  </label>
                  <input
                    id="finance-customer-statements-go-page"
                    type="number"
                    min={1}
                    max={totalPages}
                    value={goDraft}
