...
import { saveBisNewApplicationMaster } from "@/lib/actions/bis-new-applications";
...
import {
  ...
  DROPDOWN_KEY_BIS_NEW_APPLICATION_CLIENT,
...
export function BisNewApplicationsMasterForm({
  visible,
  overlay,
  formValues,
  isNewParam,
  ...
  return (
    <div className={rootClass}>
      <div className="mb-4 flex items-center justify-between gap-3">
        <h2
          id="bis-new-applications-master-form-title"
      ...
      <form
        id="bis-new-applications-master-save-form"
        action={saveBisNewApplicationMaster}
            ...
            <div className="flex min-w-0 flex-col gap-1 lg:contents">
              ...
              <div className="min-w-0 w-full lg:col-start-1 lg:row-start-2">
                <ClientDropdownField
                  ...
                  onClearSelection={() => onUpdateField("project_kind", "application")}
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[auto_auto] lg:gap-x-4 lg:gap-y-2">
            <div className="flex min-w-0 flex-col gap-1 sm:col-span-2 lg:col-span-1 lg:contents">
              ...
              <div className="min-w-0 w-full sm:col-span-2 lg:col-span-1 lg:col-start-1 lg:row-start-2">
                <ClientDropdownField
                  hideLabel
                  optionKey={DROPDOWN_KEY_BIS_NEW_APPLICATION_CLIENT}
                  name="client_id"
