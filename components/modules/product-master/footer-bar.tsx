...
export function ProductMasterFooterBar({
  matchedCount,
  grandCount,
  searchActive,
  selectedCount,
    ...
    <tfoot className="border-t border-zinc-200 bg-zinc-100 text-sm font-medium text-zinc-800 dark:border-zinc-700 dark:bg-zinc-800/90 dark:text-zinc-200">
      <tr>
        <td colSpan={8} className="px-3 py-2 align-middle">
          <div className="flex flex-col gap-3 text-left lg:flex-row lg:items-center lg:justify-between lg:gap-4">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2 lg:shrink-0">
              ...
              <button
                ...
                onClick={() => window.dispatchEvent(new CustomEvent("qe-assistant:open", { detail: { module: "products" } }))}
              >
                QE Assistant
              </button>
              <button
                ...
                title={
                  deleteDisabled
                    ...
                    : selectedCount > 0
                      ...
                      : "Delete the item currently open for edit"
                }
                onClick={onDelete}
              >
                Delete
