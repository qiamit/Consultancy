...
} from "@/lib/print/undertaking-general-iss";
import { downloadUndertakingGeneralIssWord } from "@/lib/print/undertaking-general-iss-export";
...
export function UndertakingGeneralIssModal({
  ...
  const refreshPreview = useCallback(() => {
    ...
    if (!doc) return;
    const html = buildUndertakingGeneralIssHtml(previewData, printSettings);
    doc.open();
    doc.write(html);
    doc.close();
  ...
  function handleDownloadWord() {
    void downloadUndertakingGeneralIssWord(previewData, printSettings).catch(() =>
