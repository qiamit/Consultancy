...
} from "@/lib/print/undertaking-long-duration-test";
import {
  downloadUndertakingLongDurationTestExcel,
  downloadUndertakingLongDurationTestWord,
} from "@/lib/print/undertaking-long-duration-test-export";
...
export function UndertakingLongDurationTestModal({
  ...
  const refreshPreview = useCallback(() => {
    ...
    if (!doc) return;
    const html = buildUndertakingLongDurationTestHtml(previewData, printSettings);
    doc.open();
    doc.write(html);
    doc.close();
  ...
  function handleDownloadWord() {
    void downloadUndertakingLongDurationTestWord(previewData, printSettings).catch(() =>
