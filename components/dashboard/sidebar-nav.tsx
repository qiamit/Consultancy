...
import { DASHBOARD_MODULES, type DashboardModuleKey } from "@/lib/auth/modules";
      ...
      {visibleItems.map((item) => {
        ...
        return (
          <Link
            ...
            className={`group relative flex items-center gap-3 rounded-xl px-3.5 py-2.5 font-medium transition-all duration-200 ${
              isActive
