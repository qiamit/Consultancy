...
function rowToCsvCells(r: BisProjectMasterRow): Record<BisProjectCsvHeader, string> {
...
export function buildBisProjectExportCsv(rows: BisProjectMasterRow[]): string {
...
export function parseBisProjectImportCsv(text: string):
